<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-[99%] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.product.discount')" :active="request()->routeIs('admin.product.discount')">
                        {{ __('Discounts') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.newsletters')" :active="request()->routeIs('admin.newsletters')">
                        {{ __('Newsletters') }}
                    </x-nav-link>
                </div>
            </div>
